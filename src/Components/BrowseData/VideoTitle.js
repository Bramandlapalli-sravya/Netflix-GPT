  ...
  return (
    <div className="relative bg-cover bg-center h-[600px] text-white ">
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 w-4/5 sm:w-1/2  p-5 h-[600px] flex flex-col justify-center bg-gradient-to-r from-black">
          <h1 className="text-xl font-bold mb-2">{title}</h1>
          <h2 className="text-sm mb-4">{overview}</h2>
